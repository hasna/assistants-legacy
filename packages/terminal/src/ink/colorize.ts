 ...
 * downgrades to the nearest 6×6×6 cube color: rgb(5,150,105) (Takumi
 * emerald) → idx 80 rgb(95,215,175) — close approximation.
 *
...
function clampChalkLevelForTmux(): boolean {
  ...
  if (process.env.TAKUMI_TMUX_TRUECOLOR) return false
