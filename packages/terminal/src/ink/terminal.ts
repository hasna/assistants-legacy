...
// fails when takumi runs remotely inside a VS Code integrated terminal.
...
export function supportsExtendedKeys(): boolean {
  // Takumi defaults this off because some real terminals render the UI
  ...
  if (process.env.TAKUMI_ENABLE_EXTENDED_KEYS !== '1') {
    return false
  }
